...
Se estimaron un total de 6 modelos, siguientes modelos: utilizando....
...
library(ggplot2)  # theme_minimal()

p_h6 <- plot_model(
  m5_H6,
  type  = "int",
  terms = c("nse_cmc", "prop_empleo_gmc")   # predictor y moderador
) +
  labs(
...
p_h6              # el último objeto del chunk se imprime -> figura
